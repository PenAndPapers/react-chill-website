...
const Art1 = React.forwardRef((props: Props, ref) => {
  let path1 = useRef()
  let path2 = useRef()
  let path3 = useRef()
  let path4 = useRef()
  ...
  return (
    <svg ref={ref} width="80" height="117" viewBox="0 0 80 117" fill="none" xmlns="http://www.w3.org/2000/svg" className={props.className}>
